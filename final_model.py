...
# data
import json
f = open('C:/Users/shikh/Documents/mentalhealth.json')

try:
    with open('C:/Users/shikh/Documents/mentalhealth.json', 'r') as f:
        data = json.load(f)
except FileNotFoundError:
    print("The JSON file was not found. Proceeding without it.")
    data = {}
...
def frame_data(feat_1, feat_2, is_pattern):
    ...
    data_list = []  # List to collect dataframes
    
    for intent in data['intents']:
        if is_pattern:
            for pattern in intent['patterns']:
                w = pattern
                df_to_append = pd.DataFrame([[w, intent['tag']]], columns=[feat_1, feat_2])
                data_list.append(df_to_append)
        else:
    ...
    df = pd.concat(data_list, ignore_index=True)  # Concatenate all dataframes in the list
...
checkpoint = ModelCheckpoint("model-v1.keras",
                             monitor='val_loss',
                             verbose=1,
                             save_best_only=True,
                             mode='min')
